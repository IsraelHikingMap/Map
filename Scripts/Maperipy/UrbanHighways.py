...
placeNames = [
        "Tel Aviv-Yafo", "Jerusalem", "Ramat Gan", "Givatyim", "Holon", "Bat Yam", "Bnei Brak", "Petah Tikva", "Ramat HaSharon", "Herzliya", "Kfar Saba", "Raanana", "Rishon LeZion", "Nes Ziona", "Rehovot", "Be'er Sheva", "Haifa", "Ashdod"
        ];
